...
with open('MDL_New_Drama.csv', mode='w', newline='', encoding='utf-8') as file:
    writer = csv.writer(file)
    
    
    writer.writerow(['Movie Name', 'Original Language - Year of Release', 'Overview', 'MDL Rating'])

    max_pages = 250 

    for page_number in range(1, max_pages + 1):
        try:
            url = f'https://mydramalist.com/shows/newest?page={page_number}'
